...
class AutoAddUfUfDocumentTitleToEntityHlblock620170720130605440153 extends BitrixMigration
{
    /**
     * Run the migration.
     *
  ...
  array (
    ...
    {
        $id = $this->getUFIdByCode('HLBLOCK_6', 'UF_DOCUMENT_TITLE');
        if (!$id) {
