...
class AutoAddUfUfChargePhysicalToEntityHlblock620170720131048402306 extends BitrixMigration
{
    /**
     * Run the migration.
     *
  ...
  array (
    ...
    {
        $id = $this->getUFIdByCode('HLBLOCK_6', 'UF_CHARGE_PHYSICAL');
        if (!$id) {
