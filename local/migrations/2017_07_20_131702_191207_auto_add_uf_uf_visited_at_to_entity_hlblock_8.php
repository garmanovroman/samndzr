...
class AutoAddUfUfVisitedAtToEntityHlblock820170720131702191207 extends BitrixMigration
{
    /**
     * Run the migration.
     *
  ...
  array (
    ...
    {
        $id = $this->getUFIdByCode('HLBLOCK_8', 'UF_VISITED_AT');
        if (!$id) {
