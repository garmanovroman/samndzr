...
class AutoAddUfUfJuridicalAddressToEntityHlblock320170720121633152325 extends BitrixMigration
{
    /**
     * Run the migration.
     *
    ...
    public function up()
    {
        $fields = array (
  'ENTITY_ID' => 'HLBLOCK_3',
  'FIELD_NAME' => 'UF_JURIDICAL_ADDRESS',
  'USER_TYPE_ID' => 'string',
  'XML_ID' => '',
  'SORT' => '100',
  'MULTIPLE' => 'N',
  ...
  array (
    ...
    {
        $id = $this->getUFIdByCode('HLBLOCK_3', 'UF_JURIDICAL_ADDRESS');
        if (!$id) {
