...
class AutoAddUfUfChargeTitleToEntityHlblock620170720130839058492 extends BitrixMigration
{
    /**
     * Run the migration.
     *
  ...
  array (
    ...
    {
        $id = $this->getUFIdByCode('HLBLOCK_6', 'UF_CHARGE_TITLE');
        if (!$id) {
