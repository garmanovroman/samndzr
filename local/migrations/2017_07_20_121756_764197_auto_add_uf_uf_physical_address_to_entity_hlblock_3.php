...
class AutoAddUfUfPhysicalAddressToEntityHlblock320170720121756764197 extends BitrixMigration
{
    /**
     * Run the migration.
     *
    ...
    public function up()
    {
        $fields = array (
  'ENTITY_ID' => 'HLBLOCK_3',
  'FIELD_NAME' => 'UF_PHYSICAL_ADDRESS',
  'USER_TYPE_ID' => 'string',
  'XML_ID' => '',
  'SORT' => '100',
  'MULTIPLE' => 'N',
  ...
  array (
    ...
    {
        $id = $this->getUFIdByCode('HLBLOCK_3', 'UF_PHYSICAL_ADDRESS');
        if (!$id) {
