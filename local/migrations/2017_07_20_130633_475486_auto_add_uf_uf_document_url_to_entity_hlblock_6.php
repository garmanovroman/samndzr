...
class AutoAddUfUfDocumentUrlToEntityHlblock620170720130633475486 extends BitrixMigration
{
    /**
     * Run the migration.
     *
  ...
  array (
    ...
    {
        $id = $this->getUFIdByCode('HLBLOCK_6', 'UF_DOCUMENT_URL');
        if (!$id) {
